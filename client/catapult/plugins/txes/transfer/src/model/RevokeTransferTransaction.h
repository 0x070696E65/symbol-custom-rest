...
#pragma pack(push, 1)
	...
	/// Binary layout for a RevokeTransfer transaction body.
	template<typename THeader>
	struct RevokeTransferTransactionBody : public THeader {
	private:
		using TransactionType = RevokeTransferTransactionBody<THeader>;

	public:
		DEFINE_TRANSACTION_CONSTANTS(Entity_Type_RevokeTransfer, 1)
