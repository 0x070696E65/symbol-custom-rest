...
#include "RevokeTransferTransactionPlugin.h"
#include "src/model/TransferNotifications.h"
#include "src/model/RevokeTransferTransaction.h"
...
namespace catapult { namespace plugins {
	...
	DEFINE_TRANSACTION_PLUGIN_FACTORY(RevokeTransfer, Default, Publish)
}}
