...
const transferPlugin = {
	registerSchema: builder => {
		...
		builder.addTransactionSupport(EntityType.transferv, {
			recipientAddress: ModelType.encodedAddress,
			message: ModelType.binary,
			mosaics: { type: ModelType.array, schemaName: 'mosaic' }
		});

		builder.addTransactionSupport(EntityType.revokeTransfer, {
			recipientAddress: ModelType.encodedAddress,
			message: ModelType.binary,
			mosaics: { type: ModelType.array, schemaName: 'mosaic' }
		});
	...
	registerCodecs: codecBuilder => {
		...
		codecBuilder.addTransactionSupport(EntityType.transferv, {
			deserialize: parser => {
				const transaction = {};
				transaction.recipientAddress = parser.buffer(constants.sizes.addressDecoded);
		...
		codecBuilder.addTransactionSupport(EntityType.revokeTransfer, {
			deserialize: parser => {
				const transaction = {};
				transaction.recipientAddress = parser.buffer(constants.sizes.addressDecoded);
